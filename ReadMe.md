[![CMake workflow](https://github.com/LegalizeAdulthood/boost-url-example/actions/workflows/cmake.yml/badge.svg)](https://github.com/LegalizeAdulthood/boost-url-example/actions/workflows/cmake.yml)
...
```
git clone https://github.com/LegalizeAdulthood/boost-url-example
cd boost-url-example
git submodule init
